...
namespace FlexGuard.Core.Recording
{
    ...
    public class BackupRunRecorder
    {
        ...
        public BackupRunRecorder(
            IFlexBackupEntryStore backupEntryStore,
            IFlexBackupChunkEntryStore chunkEntryStore,
            IFlexBackupFileEntryStore fileEntryStore)
        {
        ...
        /// </summary>
        public async Task<string> StartChunkAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var chunkRow = new FlexBackupChunkEntry
            {
                ...
                ChunkFileName = chunkFileName,
                ChunkHash = null, // will be known at completion
        ...
        public async Task RecordFileAsync(
            ...
            long? compressedFileSizeBytes,
            DateTime lastWriteTimeUtc,
            DateTime fileProcessStartUtc,
            DateTime fileProcessEndUtc,
            CancellationToken cancellationToken = default)
        {
            EnsureRunActive();
